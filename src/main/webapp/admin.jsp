...
<%--%>--%>
<%--&lt;%&ndash;<script>&ndash;%&gt;--%>
<%--&lt;%&ndash;    const role = <%= role != null ? role : false %>;&ndash;%&gt;--%>
<%--&lt;%&ndash;    const logged = <%= logged != null ? logged : false %>;&ndash;%&gt;--%>
<%--&lt;%&ndash;    document.addEventListener('DOMContentLoaded', function () {&ndash;%&gt;--%>
<%--&lt;%&ndash;        if (!logged) {&ndash;%&gt;--%>
<%--&lt;%&ndash;            Swal.fire({&ndash;%&gt;--%>
<%--&lt;%&ndash;                title: "Vui lòng đăng nhập với tài khoản quản trị để tiếp tục",&ndash;%&gt;--%>
<%--&lt;%&ndash;                icon: "warning",&ndash;%&gt;--%>
<%--&lt;%&ndash;                showCancelButton: true,&ndash;%&gt;--%>
<%--&lt;%&ndash;                confirmButtonText: "Đăng nhập",&ndash;%&gt;--%>
<%--&lt;%&ndash;            }).then((result) => {&ndash;%&gt;--%>
<%--&lt;%&ndash;                if (result.isConfirmed) {&ndash;%&gt;--%>
<%--&lt;%&ndash;                    window.location.href = 'login.jsp';&ndash;%&gt;--%>
<%--&lt;%&ndash;                }&ndash;%&gt;--%>
<%--&lt;%&ndash;            });&ndash;%&gt;--%>
<%--&lt;%&ndash;        } else if (!role) {&ndash;%&gt;--%>
<%--&lt;%&ndash;            Swal.fire({&ndash;%&gt;--%>
<%--&lt;%&ndash;                title: "Bạn không có quyền truy cập vào trang quản trị",&ndash;%&gt;--%>
<%--&lt;%&ndash;                icon: "warning",&ndash;%&gt;--%>
<%--&lt;%&ndash;                showCancelButton: true,&ndash;%&gt;--%>
<%--&lt;%&ndash;                confirmButtonText: "Về trang chủ",&ndash;%&gt;--%>
<%--&lt;%&ndash;            }).then((result) => {&ndash;%&gt;--%>
<%--&lt;%&ndash;                if (result.isConfirmed) {&ndash;%&gt;--%>
<%--&lt;%&ndash;                    window.location.href = 'home.jsp';&ndash;%&gt;--%>
<%--&lt;%&ndash;                }&ndash;%&gt;--%>
<%--&lt;%&ndash;            });&ndash;%&gt;--%>
<%--&lt;%&ndash;        }&ndash;%&gt;--%>
<%--&lt;%&ndash;    });&ndash;%&gt;--%>
...
<%--&lt;%&ndash;                                                                    User user = (User) session.getAttribute("kh");&ndash;%&gt;--%>
<%--&lt;%&ndash;                                                                    if (user != null) {&ndash;%&gt;--%>

<%--&lt;%&ndash;                                                                                System.out.println("boxsell: " + user.getboxsell());&ndash;%&gt;--%>
<%--&lt;%&ndash;                                                                                System.out.println("username: " + user.getUsername());&ndash;%&gt;--%>

<%--&lt;%&ndash;                                                                                if (user.getboxsell() != 0 && user.getUsername() != null) {&ndash;%&gt;--%>
<%--&lt;%&ndash;                                                                %>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                                                <li class="active yamm-fw"><a href="manager">quản lí sp</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                                                &lt;%&ndash;%>--%>
<%--&lt;%&ndash;                                                                                }&ndash;%&gt;--%>
<%--&lt;%&ndash;                                                                            }&ndash;%&gt;--%>
...
<%--                            <li class="active">--%>
<%--                                &lt;%&ndash;Tạo các thẻ liên kết đến các chức năng trong admin thông qua id của thẻ đó  &ndash;%&gt;--%>
...
<%--                    &lt;%&ndash;                    Thẻ quản lý người dùng&ndash;%&gt;--%>
<%--                    <div class="col-sm-9">--%>
...
<%--                                        &lt;%&ndash;                                    Modal xem chi tiết thông tin của 1 người dùng cụ thể&ndash;%&gt;--%>
...
<%--                                                        <div class="container">--%>
<%--                                                            &lt;%&ndash;                                                        &lt;%&ndash;%>--%>
<%--                                                            &lt;%&ndash;                                                            String userIdStr = request.getParameter("userId");&ndash;%&gt;--%>
<%--                                                            &lt;%&ndash;                                                            int userId = userIdStr != null ? Integer.parseInt(userIdStr) : -1;&ndash;%&gt;--%>
<%--                                                            &lt;%&ndash;                                                            User u = UsersDAO.getInstance().getUserById(userId);&ndash;%&gt;--%>
<%--                                                            &lt;%&ndash;                                                        %>&ndash;%&gt;--%>
<%--                                                            <div class="col-sm-9">--%>
...
<%--                                                                                            &lt;%&ndash;                                                                                        <%=u.getPhone()%>&ndash;%&gt;--%>
<%--                                                                                        </td>--%>
<%--                                                                                    </tr>--%>
<%--                                                                                    <tr>--%>
<%--                                                                                        <td>--%>
<%--                                                                                            &lt;%&ndash;                                                                                        <a class="btn btn-primary"&ndash;%&gt;--%>
<%--                                                                                            &lt;%&ndash;                                                                                           href="#change-infor">Thay đổi&ndash;%&gt;--%>
<%--                                                                                            &lt;%&ndash;                                                                                            thông&ndash;%&gt;--%>
<%--                                                                                            &lt;%&ndash;                                                                                            tin&ndash;%&gt;--%>
<%--                                                                                            &lt;%&ndash;                                                                                        </a>&ndash;%&gt;--%>
...
<%--                                                                                        </td>--%>
<%--                                                                                        <td>--%>
<%--                                                                                            &lt;%&ndash;                                                                                        <%request.setAttribute("username-forgot-pass", u.getUsername());%>&ndash;%&gt;--%>
<%--                                                                                            &lt;%&ndash;                                                                                        <a href="<%=request.getContextPath()%>/user-service/change-pass.jsp?"&ndash;%&gt;--%>
<%--                                                                                            &lt;%&ndash;                                                                                           class="btn btn-primary">Đổi&ndash;%&gt;--%>
<%--                                                                                            &lt;%&ndash;                                                                                            mật khẩu</a>&ndash;%&gt;--%>
<%--                                                                                        </td>--%>
<%--                                                                                    </tr>--%>
...
<%--                                                                                                &lt;%&ndash;                                                                                                   name="input-fullname"&ndash;%&gt;--%>
<%--                                                                                                &lt;%&ndash;                                                                                                   value=" <%=u.getFullname()%>">&ndash;%&gt;--%>
<%--                                                                                            </td>--%>
<%--                                                                                        </tr>--%>
<%--                                                                                        <tr>--%>
<%--                                                                                            <td>Tên đăng nhập:</td>--%>
<%--                                                                                            <td>--%>
<%--                                                                                                &lt;%&ndash;                                                                                            <input type="text"&ndash;%&gt;--%>
<%--                                                                                                &lt;%&ndash;                                                                                                   name="input-username"&ndash;%&gt;--%>
<%--                                                                                                &lt;%&ndash;                                                                                                   value=" <%=u.getUsername()%>">&ndash;%&gt;--%>
...
<%--                                                                                            <td>--%>
<%--                                                                                                &lt;%&ndash;                                                                                            <input type="text"&ndash;%&gt;--%>
<%--                                                                                                &lt;%&ndash;                                                                                                   name="input-email"&ndash;%&gt;--%>
<%--                                                                                                &lt;%&ndash;                                                                                                   value=" <%=u.getEmail()%>">&ndash;%&gt;--%>
...
<%--                                                                                            <td>--%>
<%--                                                                                                &lt;%&ndash;                                                                                            <input type="text"&ndash;%&gt;--%>
<%--                                                                                                &lt;%&ndash;                                                                                                   name="input-phone"&ndash;%&gt;--%>
<%--                                                                                                &lt;%&ndash;                                                                                                   value="<%=u.getSex()%>">&ndash;%&gt;--%>
...
<%--                                                                                                &lt;%&ndash;                                                                                                   name="input-date"&ndash;%&gt;--%>
<%--                                                                                                &lt;%&ndash;                                                                                                   value=" <%=u.getYearOfBirth()%>">&ndash;%&gt;--%>
...
<%--                                                                                            <td>--%>
<%--                                                                                                &lt;%&ndash;                                                                                            <input type="text"&ndash;%&gt;--%>
<%--                                                                                                &lt;%&ndash;                                                                                                   name="input-address"&ndash;%&gt;--%>
<%--                                                                                                &lt;%&ndash;                                                                                                   value="<%=u.getAddress()%>">&ndash;%&gt;--%>
...
<%--                                </div>--%>
<%--                            </div><!-- /.tab-pane -->--%>
<%--                            &lt;%&ndash;Thẻ xem toàn bộ sản phẩm lấy từ db&ndash;%&gt;--%>
...
<%--&lt;%&ndash;Modal dùng đẻ hiển thị cửa sổ popup thêm sản phẩm&ndash;%&gt;--%>
...
<%--    </div>--%>
<%--</div>--%>
<%--&lt;%&ndash;Modal hiển thị chi tiết sản phẩm&ndash;%&gt;--%>
