...
//        String address = request.getParameter("address");
        ...
        String address = provinceId + "," + districtId + "," + wardId + "," +soNha;
...
//import vn.hcmuaf.fit.drillsell.model.OrderItem;
//import vn.hcmuaf.fit.drillsell.model.User;
//import vn.hcmuaf.fit.drillsell.model.VNPayConfig;
//
//import javax.servlet.ServletException;
//import javax.servlet.annotation.WebServlet;
//import javax.servlet.http.HttpServlet;
...
//
//                String orderInfo = "Đơn hàng " + orderId; // Thông tin đơn hàng, ví dụ: mã đơn hàng
//                String bankCode = request.getParameter("bankCode"); // Mã ngân hàng nếu có
//
//                try {
//                    double amount = order.getShippingFee();
//                    String paymentUrl = VNPayConfig.createPaymentUrl((long) amount, orderInfo, bankCode);
//                    response.sendRedirect(paymentUrl);
//                } catch (UnsupportedEncodingException e) {
//                    e.printStackTrace();
//                    response.getWriter().write("Có lỗi xảy ra khi tạo URL thanh toán VNPay.");
//                }
//            } else {
//                response.getWriter().write("Có lỗi xảy ra khi tạo đơn hàng.");
//            }
