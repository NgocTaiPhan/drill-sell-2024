package vn.hcmuaf.fit.drillsell.controller.order;// Import thêm các lớp cần thiết
...
public class ApiGHN {
    public static DataRespone getData(String addressDetail, String districtId, String wardId) {
        ...
        String jsonData = "{\n" +
                ...
                "    \"from_address\": \"Khu Phố 6, Phường Linh Trung, Quận Thủ Đức, Hồ Chí Minh, Vietnam\",\n" +
        ...
        try {
            ...
            double totalFee = Double.parseDouble(data.get("total_fee").getAsString());

            // Parse expected_delivery_time to Date
            String deliveryTimeString = data.get("expected_delivery_time").getAsString();
            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss");
            Date deliveryDate = null;
            try {
                deliveryDate = dateFormat.parse(deliveryTimeString);
            ...
            dataRespone.setDeliveryDate(sqlDeliveryDate);
